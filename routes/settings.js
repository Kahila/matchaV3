...
var gender = 0, pref = 0, tag = 0, bio = 0, gio = 0, age = 0;
...
router.post('/settings',  upload.single('img'), function(req, res, next){
    ...
    if (req.body.tag == "t"){tag = 1;
    }if (req.body.gender == "t"){gender = 1;
    }if (req.body.pref == "t"){pref = 1;
    }if (req.body.gio == "t"){gio = 1;
    }if (req.body.bio == ""){bio = 1;
    }if (req.body.age == "0"){age = 1;
